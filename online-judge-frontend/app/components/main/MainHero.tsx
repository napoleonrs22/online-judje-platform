export default function MainHero() {
  return (
    <>
      <div className="bg-[#0F172A] w-full h-screen">
        <div className="flex flex-row items-center justify-between p-6">
          <div>
            <h1>Online Judge Platform</h1>
          </div>
          <div className="flex gap-4 font-medium text-xs ">
            <button className="border border-1  border-[#334155] text-[#CBD5E1] px-[12px] py-[6px] rounded-md hover:cursor-pointer">Log in</button>
            <button className="px-[12px] py-[6px] rounded-md bg-white text-[#0F172A] hover:cursor-pointer">Register</button>
          </div>
        </div>
      </div>
    </>
